 ...
 FROM 
    ...
    WHERE 
        ...
        AND (
            ...
            OR CONCAT(a.am_account, '-', a.am_subaccount) IN ('1111-1102', '1111-1105', '1111-1139', '1111-1144', '1111-1147', '1112-1102', '1112-1105', '1131-1102', '1134-1102', '5312-5303', '5322-5303', '6101-6001', '6103-6001', '6103-6060', '6104-6001', '6109-6001', '6113-6001', '6115-6001', '6131-6001', '6137-6001', '6142-6001', '6143-6001', '6144-6001', '6201-6001', '6203-6001', '6213-6001', '6301-6001', '6303-6001', '6313-6001', '6501-6001', '7115-0000', '7115-7004', '7116-0000', '7117-0000', '7125-0000', '7127-0000', '7129-0000', '7141-0000', '7141-7004', '7143-0000', '7145-0000', '7161-0000', '7163-0000', '7165-0000', '7173-0000', '7201-0000', '7203-0000', '7205-0000', '7207-0000', '7209-7005', '7209-7006', '7217-0000', '7223-0000', '7225-0000', '7301-0000', '7303-0000', '7305-0000', '7306-0000', '7307-0000', '7309-0000', '7309-7001', '7311-0000', '7312-0000', '7313-0000', '7317-0000', '7319-0000', '7321-0000', '7322-0000', '7323-0000', '7323-7001', '7327-0000', '7329-0000', '7331-0000', '7333-0000', '7337-0000', '7338-0000', '7339-0000', '7341-0000', '7343-0000', '7347-0000', '7349-0000', '7351-0000', '7353-0000', '7355-0000', '7356-0000', '7357-0000', '7361-0000', '7363-0000', '7369-0000', '7370-0000', '7371-0000', '7411-0000', '7412-0000', '7415-0000', '7416-0000', '7421-0000', '7422-0000', '7431-0000', '7501-0000', '7505-0000', '7507-0000', '7509-0000', '7654-0000', '7655-0000', '7656-0000', '7912-7011', '7912-7012', '8101-0000', '8102-0000', '8102-1202', '8104-0000', '8109-0000', '8139-0000', '8143-0000', '8201-0000', '8211-0000', '8212-0000', '8213-0000', '8214-0000', '8215-0000', '8221-0000', '8221-8201')
        );
...
--  = 71 %  + 72 %  + 73 %  + 74 %  + (75 % â€“ 8221-0000 â€“ ABS(8143-0000))
UNION ALL
SELECT
    h.Center,
...
-- Operating Expenses per procedure  (Total Operating Expenses Ã· Total Procedures)
UNION ALL
SELECT
    h.Center,
    'Operating Expenses per procedure',

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Monthly actuals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* Oct-24 */
    ISNULL(CAST(ROUND(
        (
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Mo. budget variance & budget (Apr-25) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* Mo. Bdgt Var Apr-25 = (Actual OpEx/Proc) â€“ (Budget OpEx/Proc) */
    ISNULL(CAST(ROUND(
        (
    ...
    /* Mo. Bdgt Apr-25 (Budget OpEx Ã· Actual Procedures) */
    ISNULL(CAST(ROUND(
        (
          SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_5 ELSE 0 END)+
          SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '72%' THEN h.ldr_amt_5 ELSE 0 END)+
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Year-to-date ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* YTD Apr-25 (Actual) */
    ISNULL(CAST(ROUND(
        (
...
-- Compensation per procedure  (Compensation 71% Ã· Total Procedures R1%)
UNION ALL
SELECT
    h.Center,
    'Compensation per procedure',

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Monthly actual ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    -- Oct-24
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2024' AND h.amt_class_type='actual' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_11 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2024' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_11 ELSE 0 End), 0)
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ April-25 budget variance & budget ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    -- Mo. Bdgt Var Apr-25  = (Actual comp â€“ Budget comp) Ã· Actual procedures
    ISNULL(CAST(ROUND(
        (  SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_5 ELSE 0 END) -
           SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_5 ELSE 0 END)
        ) /
    ...
    -- Mo. Bdgt Apr-25  = Budget comp Ã· Actual procedures
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_5 ELSE 0 End), 0)
    , 2) AS DECIMAL(18,2)), 0),

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Year-to-date ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    -- YTD Apr-25 (Actual)
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_1+h.ldr_amt_3+h.ldr_amt_4+h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_1+h.ldr_amt_3+h.ldr_amt_4+h.ldr_amt_5 ELSE 0 End), 0)
...
FROM #HierarchyData h
GROUP BY h.Center
-- Medical supplies & drugs per procedure  (72 % Ã· R1 %)
UNION ALL
SELECT
    h.Center,
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ April-25 budget variance & budget ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    -- Mo. Bdgt Var Apr-25 = (Actual â€“ Budget) Ã· Actual procedures
    ISNULL(CAST(ROUND(
        (  SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '72%' THEN h.ldr_amt_5 ELSE 0 END) -
           SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '72%' THEN h.ldr_amt_5 ELSE 0 END)
        ) /
    ...
    -- Mo. Bdgt Apr-25  = Budget supplies Ã· Actual procedures
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '72%' THEN h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_5 ELSE 0 End), 0)
    , 2) AS DECIMAL(18,2)), 0),
...
SELECT
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Monthly actuals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Mo. budget variance & budget (Apr-25) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Year-to-date totals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
...
-- Margin %  (EBITDA Ã· Net Revenue) expressed as percentage with 1-decimal
UNION ALL
SELECT
    h.Center,
    'Margin %',

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Monthly actual margins â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* Oct-24 */
    ISNULL(CAST(ROUND(
        CASE
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Mo. Bdgt Var (Apr-25) â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
        /* Actual Margin Apr-25 â€“ Budget Margin Apr-25, already % forms */
        (
          /* Actual % Apr-25 */
          CASE
              WHEN (   ABS(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '61%' THEN h.ldr_amt_5 ELSE 0 END))
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ YTD Apr-25 Margin (Actual) â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
        CASE
...
-- Contractual Adjustments per Procedure  (62% Ã· Total Procedures)
UNION ALL
SELECT
    h.Center,
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ April-25 budget variance & budget â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* Mo. Bdgt Var = (Actual Apr-25 / Proc) âˆ’ (Budget Apr-25 / Proc-actual) */
    ISNULL(CAST(ROUND(
        (
            SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '62%' THEN h.ldr_amt_5 ELSE 0 END)
          - SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '62%' THEN h.ldr_amt_5 ELSE 0 END)
    ...
    /* Mo. Bdgt Apr-25 = budget numerator Ã· actual procedure count */
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount LIKE '62%' THEN h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_5 ELSE 0 End), 0)
    , 2) AS DECIMAL(18,2)), 0) AS [Mo. Bdgt May 2025],

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ YTD totals â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* YTD Apr-25 (Actual) */
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE '62%' THEN h.ldr_amt_1+h.ldr_amt_3+h.ldr_amt_4+h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_1+h.ldr_amt_3+h.ldr_amt_4+h.ldr_amt_5 ELSE 0 End), 0)
...
FROM #HierarchyData h
GROUP BY h.Center
-- Linens per Procedure  (7301-0000 Ã· Total Procedures)
UNION ALL
SELECT
    h.Center,
    ...
    /* Mo. Bdgt Apr-25 (budget numerator Ã· actual procedures) */
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='budget' AND h.FullAccount='7301-0000' THEN h.ldr_amt_5 ELSE 0 END) /
        NULLIF(SUM(CASE WHEN h.processing_yr='2025' AND h.amt_class_type='actual' AND h.FullAccount LIKE 'R1%' THEN h.ldr_amt_5 ELSE 0 End), 0)
    , 2) AS DECIMAL(18,2)), 0) AS [Mo. Bdgt May 2025],

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ YTD ratios â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* YTD Apr-25 (Actual) */
    ISNULL(CAST(ROUND(
...
FROM #HierarchyData h
GROUP BY h.Center
-- Medical Supplies per Procedure  (7201-0000 + 7203-0000) Ã· Total Procedures
UNION ALL
SELECT
    h.Center,
...
FROM #HierarchyData h
GROUP BY h.Center
-- Drugs per Procedure  (7205-0000 + 7207-0000) Ã· Total Procedures
UNION ALL
SELECT
    h.Center,
...
-- Bad Debt % of Net Revenue  (6301-6001 Ã· Net Revenue)
-- Bad Debt % of Net Revenue  (6301-6001 Ã· Net Revenue)  -- now returned as a fraction
UNION ALL
SELECT
    h.Center,
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Mo. Bdgt Var & Budget Apr-25 â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
        (
          /* Actual ratio Apr-25 */
          CASE
...
-- Compensation per Day  (Total Compensation 71% Ã· S005-0000)
UNION ALL
SELECT
    h.Center,
    'Compensation per Day',

    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€ Monthly actual values â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    /* Oct 2024 */
    ISNULL(CAST(ROUND(
        SUM(CASE WHEN h.processing_yr='2024' AND h.amt_class_type='actual' AND h.FullAccount LIKE '71%' THEN h.ldr_amt_11 ELSE 0 END) /
...
FROM #HierarchyData h
GROUP BY h.Center
-- Procedures per Day  (Total Procedures R1% Ã· S005-0000)
UNION ALL
SELECT
    h.Center,
    'Procedures per Day',
...
FROM #HierarchyData h
GROUP BY h.Center
-- Gross revenue per Procedure  (ABS(61%) Ã· Total Procedures)
UNION ALL
SELECT
    h.Center,
...
FROM #HierarchyData h
GROUP BY h.Center
-- Net Cash Collection per procedure (Cash collections 11% Ã· Total Procedures R1%)
UNION ALL
SELECT
    h.Center,
...
-- Center EBITDA per Procedure (EBITDA Ã· Total Procedures)
UNION ALL
SELECT
    h.Center,
...
-- Center Level EBITDA per center  (Net Revenue â€“ Total Operating Expenses)
UNION ALL
SELECT
    h.Center,
    'Center Level EBITDA',
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Mo. budget variance & budget (Apr-25) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    -- Mo. Bdgt Var Apr-25 = Actual EBITDA âˆ’ Budget EBITDA
    ISNULL(CAST(ROUND(
        (
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Year-to-date totals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ISNULL(CAST(ROUND(
        ((SUM(CASE WHEN h.processing_yr = '2025' AND h.amt_class_type = 'actual' AND h.FullAccount LIKE '61%' THEN h.ldr_amt_1 + h.ldr_amt_2 + h.ldr_amt_3 + h.ldr_amt_4 + h.ldr_amt_5 ELSE 0 END) * -1) -
		(SUM(CASE WHEN h.processing_yr = '2025' AND h.amt_class_type = 'actual' AND h.FullAccount = '8109-0000' THEN h.ldr_amt_1 + h.ldr_amt_2 + h.ldr_amt_3 + h.ldr_amt_4 + h.ldr_amt_5 ELSE 0 END) * -1)) -
            (SUM(CASE WHEN h.processing_yr = '2025' AND h.amt_class_type = 'actual' AND h.FullAccount LIKE '62%' THEN h.ldr_amt_1 + h.ldr_amt_2 + h.ldr_amt_3 + h.ldr_amt_4 + h.ldr_amt_5 ELSE 0 END) -
...
GROUP BY h.Center;
DROP TABLE #HierarchyData;
-- Sign flip accounts: 5312-5303, 5322-5303, 6101-6001, 6103-6001, 6103-6060, 6104-6001, 6109-6001, 6113-6001, 6115-6001, 6131-6001, 6137-6001, 6142-6001, 6143-6001, 6144-6001, 6501-6001, 8102-0000, 8102-1202, 8104-0000, 8109-0000, 8139-0000, 8143-0000